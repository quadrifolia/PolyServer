...
Service = pam            # Pluggable authentication messages
...
# Create mail logfile configuration
cat > /etc/logwatch/conf/logfiles/mail.conf << EOF
# Mail logfile configuration for postfix/sendmail
LogFile = /var/log/mail.log
LogFile = /var/log/mail.info
LogFile = /var/log/mail.warn
LogFile = /var/log/mail.err
Archive = /var/log/mail.log.*
*ExpandRepeats
*ApplyStdDate
EOF
